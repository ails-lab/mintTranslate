...
public class ItemHtml extends GeneralAction {
	public String id;
	private Item item;
	
	Set<String> schemas= TextParseUtil.commaDelimitedStringToSet(Config.get("euscreen.portal.schema"));

	@Action(value="ItemHtml",interceptorRefs=@InterceptorRef("defaultStack"))
	...
	public String getXml() {
		...
		String xsl = "<?xml-stylesheet type=\"text/xsl\" href=\"xsl/EUscreenCoretoHTML.xsl\"?>\n";
		return head+xsl+xml;
	}
