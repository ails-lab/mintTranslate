 ...
 *
 */
public class PublishLocloud implements Runnable{
	private static final String DUMMY_ID = "carare:000000";
	
	public static final Logger log = Logger.getLogger( PublishLocloud.class );
	...
	public PublishLocloud( Dataset ds ) {
		this.dataset = ds;
	...
	public void runInThread() {
		...
		try {
			...
			File tmpFile = File.createTempFile("locloud_" + pubname+"_", ".tgz" );
	...
	private void writePackageInfo( File pkgData, TarArchiveOutputStream output ) throws Exception {
		...
		writer.write( "<project name=\"locloud\" />" );
